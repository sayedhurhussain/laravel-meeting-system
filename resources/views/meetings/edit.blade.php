            ...
            <div class="card-body">
                <form method="POST" action="{{ route('meetings.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('attendee1') is-invalid @enderror" id="attendee1" name="attendee1" value="{{ $meeting->attendee1->email }}" required>
                        @error('attendee1')
                            <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('attendee2') is-invalid @enderror" id="attendee2" name="attendee2" value="{{ $meeting->attendee2->email }}" required>
                        @error('attendee2')
                            <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
